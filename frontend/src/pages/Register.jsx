...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-parchment flex items-start sm:items-center justify-center px-4 sm:px-8 py-8 sm:py-12">
            <div className="w-full max-w-md">
                <Link to="/login" className="font-mono text-xs text-ink-muted hover:text-kale mb-6 inline-block transition-colors">
                    ← Back to login
                </Link>
